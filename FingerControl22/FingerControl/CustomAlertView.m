...
@synthesize backImage,textColor;
...
- (void)layoutSubviews
{
	for (UIView *subview in self.subviews){ //Fast Enumeration
      ...
      if (self.textColor) {
        ...
        label.textColor = [UIColor blackColor];//[UIColor colorWithRed:210.0f/255.0f green:210.0f/255.0f blue:210.0f/255.0f alpha:1.0f]
      [label setFont:[UIFont fontWithName:@"MarkerFelt-Wide" size:16]];
			label.shadowColor = [UIColor blackColor];
			label.shadowOffset = CGSizeMake(0.0f, 1.0f);
		}
	}
  
  UIView *test=[[UIView alloc]initWithFrame:CGRectMake(10,10,20,40)];
...
- (void)drawRect:(CGRect)rect 
{
  ...
  self.frame =CGRectMake(312,244,400,300);
